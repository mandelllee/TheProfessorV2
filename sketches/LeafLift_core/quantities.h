...
const char string_0[]  = "temperature";   // "String 0" etc are strings to store - change to suit.
const char string_1[]  = "humidity";
const char string_2[]  = "illuminance";
const char string_3[]  = "pressure";
const char string_4[]  = "voltage";
const char string_5[]  = "current";

const char* const quantities_table[]  = {string_0, string_1, string_2, string_3, string_4, string_5};
